...
-- The default awesome launcher on the top-left corner
...
globalkeys = gears.table.join(
	awful.key({ modkey, "Ctrl" }, "s", hotkeys_popup.show_help, { description = "show help", group = "awesome" }),
	...
	end, { description = "Open up gnome settings", group = "launcher" }),

	awful.key({ modkey, "Shift" }, "s", function()
		awful.util.spawn("/home/subrat/.config/rofi/applets/applets/screenshot.sh")
	end, { description = "Open up screenshot menu", group = "launcher" }),
...
awful.spawn.with_shell("/home/subrat/.config/polybar/launch_polybar.sh")
